...
def exploracion_dataframe(df, columna):
    """
    ...
    Params:
    - df (DataFrame): El DataFrame que se va a explorar.
    - columna (str): El nombre de la columna que se utilizará como control para dividir el DataFrame.

    Returns: 
    No devuelve nada directamente, pero imprime en la consola la información exploratoria.
    """
    print(f"El número de datos es {df.shape[0]} y el de columnas es {df.shape[1]}")
    print("\n ..................... \n")
    ...
    for categoria in df[columna].unique():
        dataframe_filtrado = df[df[columna] == categoria]
